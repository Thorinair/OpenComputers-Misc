--[[
    Application: OC Component Methods (occm)
    ...
    Usage:
    	Run the application and then type the component name you wish to scan. The methods will be listed as output with detailed descriptions when available.
    Requirements: 
    	Due to OC's lack of output scrolling, a larger screen is highly recommended.
--]]
