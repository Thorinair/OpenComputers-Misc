--[[
    ...
    Requirements: 
    	...
    	Additionally, the VariPass library from this same repository should be installed on the OpenComputer.
--]]
...
function process()
	while true do
		...
		if result == vp.RESULT_SUCCESS then
			print("Success reading from VariPass!")
		else 
			print("Error reading from VariPass, code: " .. result)
		end	
		...
		if result == vp.RESULT_SUCCESS then
			print("Success writing to VariPass!")
		else 
			print("Error writing to VariPass, code: " .. result)
		end	
